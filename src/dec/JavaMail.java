...
public class JavaMail {
	...
	// 发件人用户名、密码
	private String SEND_USER = "280587412@qq.com";
	private String SEND_UNAME = "280587412";
	private String SEND_PWD = "asdfghjkl123";
	// 建立会话
	...
	public static void main(String[] args) {
		...
		se.doSendHtmlEmail("邮件头文件名", "邮件内容", "duanml@jointsky.com");
	}
}
